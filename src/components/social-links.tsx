...
function TgIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
const btn =
  "h-8 w-8 inline-flex items-center justify-center rounded-lg text-gray-500 dark:text-white/45 hover:text-gray-900 dark:hover:text-white/75 hover:bg-black/5 dark:hover:bg-white/5 transition touch-manipulation";
