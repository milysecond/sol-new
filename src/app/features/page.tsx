...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { href: "/earn", title: "Earn (Lulo)", blurb: "Protected USDC yield via Lulo. Deposit and withdraw with Face ID.", icon: TrendingUp },
      { href: "/stake", title: "Stake SOL", blurb: "Native validator staking. Delegate, deactivate, withdraw.", icon: TrendingUp },
      { href: "/lst", title: "Liquid stake", blurb: "Sanctum ecosystem LSTs (jitoSOL, mSOL, INF, more).", icon: TrendingUp },
