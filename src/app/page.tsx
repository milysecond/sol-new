...
const products = [
  { href: "/token", emoji: "🪙", title: "Token", desc: "Launch a token in seconds", tag: "sol.new/token" },
  { href: "/nft", emoji: "🖼️", title: "NFT", desc: "Mint an NFT from any image", tag: "sol.new/nft" },
  { href: "/wallet", emoji: "👛", title: "Wallet", desc: "Instant wallet, no install", tag: "sol.new/wallet" },
  { href: "/pay", emoji: "💸", title: "Pay", desc: "Create a payment link", tag: "sol.new/pay" },
  { href: "/dao", emoji: "🏛️", title: "DAO", desc: "Spin up a multisig", tag: "sol.new/dao" },
];
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {products.map((p) => (
              ...
              >
                ...
                <span className="text-xs text-white/20 font-mono hidden sm:block">{p.tag}</span>
              </Link>
            ))}
          </div>
