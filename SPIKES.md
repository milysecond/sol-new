...
Against `@lazorkit/wallet@2.0.1` (installed; peers include `@solana/kora`, anchor 0.31, web3.js ^1.98.2 yes compatible with our 1.98.4).
...
## Address model correction vs plan 
...
## Program identity — IMPORTANT (found during runtime spikes)
